...
def extract_chart_data_from_image(
    *,
    ...
    rtx_translate_protocol: str = "grpc",
    auth_token: str = "",
) -> DataFrame:
    """
    ...
    rtx_translate_protocol : str, optional
    ...
    extraction_config = ChartExtractorSchema(
        **{
            "endpoint_config": {
                "yolox_endpoints": yolox_endpoints,
                "rtx_translate_endpoints": rtx_translate_endpoints,
...
def extract_table_data_from_image(
    *,
    df_ledger: pd.DataFrame,
    yolox_endpoints: Optional[Tuple[str, str]] = None,
    rtx_translate_endpoints: Optional[Tuple[str, str]] = None,
    yolox_protocol: Optional[str] = None,
    rtx_translate_protocol: Optional[str] = None,
    ...
    rtx_translate_endpoints : Optional[Tuple[str, str]], default=None
    ...
    rtx_translate_protocol : Optional[str], default=None
