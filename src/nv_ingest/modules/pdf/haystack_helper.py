...
class PDFtoTextConverterStream(PDFToTextConverter):
    def convert(
        ...
        sort_by_position : Optional[bool]
            Specifies whether to sort the extracted text by positional coordinates or logical reading order.
        ...
        ocr : Optional[Literal["auto", "full"]]
            Specifies whether to use OCR to extract text from images in the PDF. If set to "auto", OCR is used only to extract text
        ...
        ocr_language : Optional[str]
            Specifies the language to use for OCR. The default language is English, which language code is `eng`.
        ...
        multiprocessing : Optional[Union[bool, int]]
            We use multiprocessing to speed up PyMuPDF conversion, you can disable it by setting it to False.
    ...
    def _read_pdf(
        ...
        ocr_language : str
            ...
            To combine multiple languages, pass a string with the language codes separated with a plus ("+"). 
...
def haystack(pdf_stream, extract_text: bool, extract_images: bool, extract_tables: bool, **kwargs):
    ...
    **kwargs
    ...
    logger.info(f"Extracting PDF with haystack backend.")
