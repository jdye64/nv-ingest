...
class LlamaNemotronEmbed1BV2Embedder:
    ...
    def __post_init__(self) -> None:
        ...
        self._tokenizer = AutoTokenizer.from_pretrained(MODEL_ID, cache_dir=hf_cache_dir, local_files_only=True)
        self._model = AutoModel.from_pretrained(
            MODEL_ID, trust_remote_code=True, cache_dir=hf_cache_dir, local_files_only=True
        )
