...
def get_version():
    release_type = os.getenv("NV_INGEST_COMMON_RELEASE_TYPE", "dev")
    version = os.getenv("NV_INGEST_COMMON_VERSION")
    rev = os.getenv("NV_INGEST_COMMON_REV", "0")
