...
1. **Bug Reports, Feature Requests, and Documentation Issues:** Please file
   an [issue](https://gitlab-master.nvidia.com/dl/ai-services/microservices/nv-ingest/-/issues) with a detailed
   description of
...
git clone https://gitlab-master.nvidia.com/dl/ai-services/microservices/nv-ingest $NV_INGEST_ROOT
cd $NV_INGEST_ROOT
```
...
1. **Finding an Issue:** Start with issues
   labeled [good first issue](https://gitlab-master.nvidia.com/dl/ai-services/microservices/nv-ingest).
...
4. **Submit Your Pull Request:
   ** [Create a pull request](https://gitlab-master.nvidia.com/dl/ai-services/microservices/nv-ingest/compare) once your
   code is ready.
...
the [project boards](https://gitlab-master.nvidia.com/dl/ai-services/microservices/nv-ingest/projects) for prioritized
issues. Look for unassigned issues and follow the steps starting from **Claim an Issue**.

### Workflow

1. **NV-Ingest Foundation**: Built on top
   of [NVIDIA Morpheus](https://github.com/nv-morpheus/Morpheus/blob/branch-24.06/docs/source/developer_guide/architecture.md).
...
4. **Job Submission**:
   ...
   - The `metadata` column contents correspond to
     the [schema-enforced metadata format of returned data](https://docs.google.com/document/d/1yxpsHBuVuTFP4rlkorHvMdmJrhPaxuihNs0ygh-eLRM).
